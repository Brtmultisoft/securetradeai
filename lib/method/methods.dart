...
import 'package:rapidtradeai/model/HomePageBannerModel.dart';
import 'package:rapidtradeai/model/MineModel.dart';
import 'package:rapidtradeai/model/NewsModel.dart';
import 'package:rapidtradeai/model/RevenueDetailBydate.dart';
import 'package:rapidtradeai/model/TradeHistoryModel.dart';
import 'package:rapidtradeai/model/dailyRoiHistoryModel.dart';
import 'package:rapidtradeai/model/deposit_history_model.dart';
import 'package:rapidtradeai/model/incomeManagementModel.dart';
import 'package:rapidtradeai/model/incomeSummaryModel.dart';
import 'package:rapidtradeai/model/levelIncomeModel.dart';
import 'package:rapidtradeai/model/revenueModel.dart';
...
import 'package:rapidtradeai/src/Service/http_services.dart';
...
class CommonMethod {
  ...
  Future<DepositTransactiondetail> getDepositTransactionDetail(int page) async {
    try {
      ...
      print('🔍 Using endpoint: $transactionrecord');
