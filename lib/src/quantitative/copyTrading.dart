        ...
        traders = [
          {
            ...
            'experience': '5 years',
            'description':
                'Specialized in crypto swing trading with focus on BTC and ETH pairs.',
          },
          {
            'id': '2',
            'name': 'Sarah Chen',
            ...
            'experience': '3 years',
            'description':
                'Expert in high-frequency trading with quick entry and exit points.',
          },
          {
            'id': '3',
            ...
            'experience': '7 years',
            'description':
                'Long-term trend analysis with focus on market cycles.',
          },
          {
            'id': '4',
            'name': 'Emma Wilson',
            ...
            'experience': '4 years',
            'description':
                'Specialized in identifying and trading breakout patterns.',
          },
          {
            'id': '5',
            'name': 'David Kim',
            ...
            'experience': '6 years',
            'description':
                'Expert in momentum trading with focus on volume analysis.',
          },
        ];
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildInfoRow(
                'Strategy', trader['strategy']?.toString() ?? 'Not specified'),
            _buildInfoRow('Experience',
                trader['experience']?.toString() ?? 'Not specified'),
            _buildInfoRow('Min Investment',
                '\$${trader['minInvestment']?.toString() ?? "0"}'),
            _buildInfoRow(
                'Copy Fee', trader['copyFee']?.toString() ?? 'Not specified'),
            const SizedBox(height: 16),
            Text(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Lottie.asset("assets/lotties/coming.json"),
