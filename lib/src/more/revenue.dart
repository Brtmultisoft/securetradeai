  ...
  Widget _buildSpotTradingHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color:  TradingTheme.secondaryAccent.withOpacity(0.3)),
      ),
      child: Row(
        children: const [
          Icon(
  ...
  Widget _buildFutureTradingTab() {
    return RefreshIndicator(
      ...
      child: isFutureAPIcalled
          ? const Center(
              child: CircularProgressIndicator(color: TradingTheme.secondaryAccent))
          : SingleChildScrollView(
              child: Column(
                children: [
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(icon, color:  TradingTheme.secondaryAccent, size: 24),
        ),
        const SizedBox(width: 12),
        Expanded(
          child: Column(
