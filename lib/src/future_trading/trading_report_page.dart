              ...
              data: ThemeData.dark().copyWith(
                colorScheme:  ColorScheme.dark(
                  ...
                  secondary: FutureTradingTheme
                      .secondaryAccent, // Today's date highlight
                ...
                textButtonTheme: TextButtonThemeData(
                  style: TextButton.styleFrom(
                    foregroundColor:
                        TradingTheme.secondaryAccent, // CANCEL/OK button text
                  ),
                ),
              ),
              child: child!,
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        const Icon(Icons.south, color: TradingTheme.errorColor),
                        const SizedBox(height: 8),
                        const Text('Short Positions',
                            style: TradingTypography.bodySmall),
                        const SizedBox(height: 4),
