...
import 'package:rapidtradeai/src/future_trading/trading_report_page.dart';
        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              // Header
              Padding(
                padding: EdgeInsets.symmetric(horizontal: kIsWeb ? 32 : 20), // Bigger padding for web
                child: Row(
                  children: [
                    const Text(
              ...
              Expanded(
                child: SingleChildScrollView(
                  padding: EdgeInsets.all(kIsWeb ? 32 : 20), // Bigger padding for web
                  child: Column(
              ...
              data: ThemeData.dark().copyWith(
                colorScheme: const ColorScheme.dark(
                  ...
                  primary: TradingTheme
                      .secondaryAccent, // Selected date background (yellow)
                  onPrimary:
                      Colors.black, // Selected date text (black on yellow)
                  surface: FutureTradingTheme
                      .cardBackground, // Calendar background (dark)
                  onSurface: Colors
                      .white, // Calendar dates text (WHITE - force override)
                  background:
                      FutureTradingTheme.cardBackground, // Dialog background
                  onBackground: Colors.white, // Text on dialog background
                  secondary: FutureTradingTheme
                      .primaryAccent, // Today's date highlight
                  onSecondary: Colors.black, // Today's date text
                ),
                dialogBackgroundColor: FutureTradingTheme.cardBackground,
                ...
                textButtonTheme: TextButtonThemeData(
                  style: TextButton.styleFrom(
                    foregroundColor: FutureTradingTheme
                        .secondaryAccent, // CANCEL/OK button text
                  ),
                ),
              ),
              child: child!,
          ...
          children: [
            ...
            Text(
              date != null
                  ...
                  : 'Select date',
              style: TradingTypography.bodyMedium.copyWith(
                color: date != null ? Colors.black : Colors.black,
              ),
            ),
          ],
        ),
  ...
  Color _getCloseReasonColor(String reason) {
    switch (reason) {
      ...
      case 'LIQUIDATION':
        return FutureTradingTheme.errorColor;
      default:
        return FutureTradingTheme.primaryAccent;
    }
  }
