...
class _FutureTradePageState extends State<FutureTradePage>
  ...
  Future<void> _loadWhitelistingStatus() async {
    ...
    try {
      ...
      print(
          '🔄 Checking whitelisting status for ${symbolsToCheck.length} popular symbols: $symbolsToCheck');

      final whitelistingResults =
          await SymbolWhitelistingService.checkMultipleSymbols(symbolsToCheck);
      ...
      if (mounted) {
        ...
        print(
            '📊 Popular symbols whitelisting status loaded: ${whitelistingResults.length} symbols checked');
      }
    } catch (e) {
  ...
  void _handleSymbolSelection(FutureSymbol symbol) async {
    ...
    if (_whitelistingStatus.containsKey(symbol.symbol)) {
      ...
      if (isWhitelisted) {
        ...
        print(
            '✅ Symbol ${symbol.symbol} is whitelisted (cached), proceeding with selection');
        setState(() {
    ...
    try {
      ...
      final isWhitelisted =
          await SymbolWhitelistingService.isSymbolWhitelisted(symbol.symbol);
      ...
      if (isWhitelisted) {
        // Symbol is whitelisted, proceed with selection
        print(
            '✅ Symbol ${symbol.symbol} is whitelisted, proceeding with selection');
        setState(() {
          _selectedSymbol = symbol;
          _priceController.text = symbol.currentPrice.toStringAsFixed(2);
          _leverage = _leverage > 10.0 ? 10.0 : _leverage;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: kIsWeb ? 24 : 16), // Bigger spacing for web
    ...
    return ListView(
      ...
      children: [
        ...
        if (recommendedCoins.isNotEmpty && _searchQuery.isEmpty) ...[
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: TradingTheme.secondaryAccentGradient,
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Row(
          ...
          ...recommendedCoins.map((symbol) => Padding(
            padding: const EdgeInsets.symmetric(vertical: 6.0),
            child: _buildSymbolOption(symbol),
          )),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      const Icon(
                        Icons.list,
                        color: TradingTheme.backgroundColor,
                        size: 16,
                      ),
                      const SizedBox(width: 4),
                      Text(
        ...
        children: [
          ...
          SliderTheme(
            data: SliderTheme.of(context).copyWith(
              activeTrackColor: TradingTheme.secondaryAccent,
              inactiveTrackColor: TradingTheme.hintText,
              thumbColor: TradingTheme.secondaryAccent,
              overlayColor: TradingTheme.secondaryAccent.withOpacity(0.2),
            ),
            child: Slider(
              value: _leverage,
              min: 1.0,
    ...
    return AnimatedTradingCard(
      child: Column(
        ...
        children: [
          ...
          const Divider(color: TradingTheme.secondaryAccent),
          _buildSummaryRow(
            'Total Required',
