...
class MarginConfig extends StatefulWidget {
  const MarginConfig({Key? key, this.coinname, this.calllimit})
      : super(key: key);
  final coinname;
  final calllimit;
  @override
  _MarginConfigState createState() => _MarginConfigState();
}

class _MarginConfigState extends State<MarginConfig> {
...
///////////////////////////////////////////////////////////////////////////
                ...
                children: [
                  ...
                  Visibility(
                    ...
                    child: Container(
                        ...
                        child: commonWidget(
                            "First Call", marginfirstCall, multiplyfirstCall)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 2) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("2nd Call", marginsecoundndcall,
                            multiplysecoundndcall)),
                  ),
                  Visibility(
                  ...
                  Visibility(
                    ...
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child:
                            commonWidget("6th Call", marginsix, multiplysix)),
                  ),
                  Visibility(
                  ...
                  Visibility(
                    ...
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child:
                            commonWidget("9th Call", marginnine, multiplynine)),
                  ),
                  Visibility(
                    ...
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child:
                            commonWidget("10th Call", marginten, multiplyten)),
                  ),
                  Visibility(
                  ...
                  Visibility(
                    ...
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget(
                            "13th Call", marginthirteen, multiplythirteen)),
                  ),
                  Visibility(
                  ...
                  Visibility(
                    ...
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child:
                            commonWidget("20 Call", margintwentry, multiply20)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 21) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("21 Call", margin21, multiply21)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 22) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("22th Call", margin22, multiply22)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 23) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("23th Call", margin23, multiply23)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 24) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("24th Call", margin24, multiply24)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 25) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("25th Call", margin25, multiply25)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 26) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("26th Call", margin26, multiply26)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 27) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("27th Call", margin27, multiply27)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 28) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("28th Call", margin28, multiply28)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 29) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("29th Call", margin29, multiply29)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 30) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("30th Call", margin30, multiply30)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 31) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("31 Call", margin31, multiply31)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 32) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("32th Call", margin32, multiply32)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 33) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("33th Call", margin33, multiply33)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 34) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("34th Call", margin34, multiply34)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 35) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("35th Call", margin35, multiply35)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 36) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("36th Call", margin36, multiply36)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 37) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("37th Call", margin37, multiply37)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 38) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("38th Call", margin38, multiply38)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 39) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("39th Call", margin39, multiply39)),
                  ),
                  ...
                  Visibility(
                    ...
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("40th Call", margin40, multiply40)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 41) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("41th Call", margin41, multiply41)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 42) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("42th Call", margin42, multiply42)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 43) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("43th Call", margin43, multiply43)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 44) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("44th Call", margin44, multiply44)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 45) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("45th Call", margin45, multiply45)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 46) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("46th Call", margin46, multiply46)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 47) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("47th Call", margin47, multiply47)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 48) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("48th Call", margin48, multiply48)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 49) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("49th Call", margin49, multiply49)),
                  ),
                  Visibility(
                    visible: (widget.calllimit < 50) ? false : true,
                    child: Container(
                        margin: EdgeInsets.only(left: 15, right: 15),
                        child: commonWidget("50th Call", margin50, multiply50)),
                  ),
                  SizedBox(
                    width: 20,
                  ),
  ...
  Widget commonWidget(
      String id, TextEditingController controller, multipleycontroller) {
    return Column(
  ...
  _updateMarginConfig() async {
    try {
      ...
      var bodydata = jsonEncode({
        ...
        "multiply_ration_29": multiply28.text,
      ...
      final res =
          await http.post(Uri.parse(tradeSettingUpdatewwm), body: bodydata);
      if (res.statusCode == 200) {
        var data = jsonDecode(res.body);
        if (data['status'] == "success") {
