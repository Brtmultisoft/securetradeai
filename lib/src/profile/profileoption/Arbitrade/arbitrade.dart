...
import 'package:rapidtradeai/model/dailyRoiHistoryModel.dart';
import 'package:rapidtradeai/model/incomeManagementModel.dart';
import 'package:rapidtradeai/model/incomeSummaryModel.dart';
import 'package:rapidtradeai/model/userInvestmentsModel.dart';
import 'package:rapidtradeai/model/userRankModel.dart';
import 'package:rapidtradeai/src/Service/assets_service.dart';
import 'package:rapidtradeai/src/profile/profileoption/Arbitrade/income_details.dart';
import 'package:rapidtradeai/src/profile/profileoption/Arbitrade/team/team_arbitrade.dart';
...
class _ArbiTradeSectionState extends State<ArbiTradeSection>
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        ...
                        style: TextStyle(
                          color: Colors.yellow,
                          fontSize: kIsWeb ? 24 : 16, // Much bigger for web
                        ),
                      ),
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: kIsWeb ? 28 : 16, // Much bigger for web
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: kIsWeb ? 16 : 11, // Much bigger for web
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: kIsWeb ? 20 : 14, // Much bigger for web
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                ],
  ...
  Widget _buildTeamStat(String title, String value, IconData icon) {
    return Container(
      padding: EdgeInsets.all(kIsWeb ? 20 : 12), // Bigger padding for web
      decoration: BoxDecoration(
        color: Colors.black.withOpacity(0.05),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
      ...
      child: Column(
        ...
        children: [
          Icon(
            ...
            size: kIsWeb ? 28 : 18, // Bigger icon for web
          ),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontSize: kIsWeb ? 14 : 10, // Much bigger for web
              fontWeight: FontWeight.w500,
            ),
            textAlign: TextAlign.center,
            maxLines: 2,
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: kIsWeb ? 32 : 20, // Much bigger for web
                          fontWeight: FontWeight.bold,
                          letterSpacing: 1.2,
                        ),
                      ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Package Features
                    _buildFeatureRow(
                        Icons.trending_up, 'Daily TPS', '0.166%'),
            ...
            children: [
              ...
              Expanded(
                child: _buildInvestmentDetail(
                    'Daily TPS', '${investment.dailyRoiPercentage}6%'),
              ),
              Expanded(
