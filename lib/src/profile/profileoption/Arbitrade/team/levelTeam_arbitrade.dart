...
import 'package:securetradeai/src/profile/profileoption/Arbitrade/team/teamdetail_arbitrade.dart';

class LevelTeamArbitrade extends StatefulWidget {
  const LevelTeamArbitrade({Key? key, this.image}) : super(key: key);
  final image;
  @override
  _LevelTeamArbitradeState createState() => _LevelTeamArbitradeState();
}

class _LevelTeamArbitradeState extends State<LevelTeamArbitrade> {
  ...
  _goToDetailPage(String level) {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => TeamDetailArbitrade(
                  data: data,
