...
import 'package:securetradeai/src/profile/profileoption/Arbitrade/team/enhanced_level_team_arbitrade.dart';
import 'package:securetradeai/src/profile/profileoption/Arbitrade/team/enhanced_rank_team_arbitrade.dart';
import 'package:securetradeai/src/profile/profileoption/Arbitrade/team/enhanced_team_detail_arbitrade.dart';
...
class TeamArbitrade extends StatefulWidget {
  const TeamArbitrade({Key? key, this.image}) : super(key: key);
  final dynamic image;
  @override
  TeamArbitradeState createState() => TeamArbitradeState();
}

class TeamArbitradeState extends State<TeamArbitrade> {
              ...
              child: TabBarView(children: [
                isAPIcalled
                    ...
                    : checkdata
                        ...
                        : _getDirect(),
                EnhancedArbitradePageLevelTeam(
                  image: widget.image,
                ),
              ]),
            )
