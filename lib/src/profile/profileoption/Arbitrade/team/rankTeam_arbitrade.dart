...
class RankArbitrade extends StatefulWidget {
  const RankArbitrade({Key? key, this.image}) : super(key: key);
  final image;

  @override
  _RankArbitradeState createState() => _RankArbitradeState();
}

class _RankArbitradeState extends State<RankArbitrade> {
