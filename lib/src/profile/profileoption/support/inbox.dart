...
import 'package:rapidtradeai/src/profile/profileoption/support/create.dart';
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: Scaffold(
        ...
        body: isAPIcalled
            ? Center(child: CircularProgressIndicator(color: rapidtradeaicolor))
            : checkdata
                ? Center(
                    child: Image.asset(
                      "assets/img/logo.png",
        ...
        floatingActionButton: SpeedDial(
          foregroundColor: rapidtradeaicolor,
          backgroundColor: bg,
          ...
          children: [
            SpeedDialChild(
                ...
                backgroundColor: rapidtradeaicolor,
                label: "create".tr),
          ],
        ),
      ),
