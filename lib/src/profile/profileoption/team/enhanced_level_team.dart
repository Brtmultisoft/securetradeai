...
import 'package:rapidtradeai/src/profile/profileoption/Team/enhanced_team_detail.dart';
import 'package:rapidtradeai/src/widget/lottie_loading_widget.dart';

import '../../../../data/api.dart';
import '../../../Service/assets_service.dart';

class EnhancedLevelTeam extends StatefulWidget {
  const EnhancedLevelTeam({Key? key, this.image}) : super(key: key);
  final image;
  @override
  EnhancedLevelTeamState createState() => EnhancedLevelTeamState();
}

class EnhancedLevelTeamState extends State<EnhancedLevelTeam> {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          //   collapsedIconColor: TradingTheme.secondaryAccent,
          //   iconColor: TradingTheme.secondaryAccent,
          //   title: const Text(
          //     "More Levels",
          //     style: TextStyle(
          //       color: Colors.white,
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 0,
            child: Center(
              child: _buildHierarchyNode("You", TradingTheme.secondaryAccent, true),
            ),
          ),
          // Connecting lines
          Positioned(
