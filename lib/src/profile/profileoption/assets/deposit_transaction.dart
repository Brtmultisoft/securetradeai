...
import 'package:rapidtradeai/model/DeposittransactionModel.dart'
    as DepositTransactionModelAlias;
import 'package:rapidtradeai/src/Service/assets_service.dart';
import 'package:rapidtradeai/src/profile/profileoption/assets/transfer.dart';
    ...
    return Container(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border:
                Border.all(color: TradingTheme.secondaryAccent.withOpacity(0.5)),
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: ExpansionTile(
          ...
          collapsedIconColor: TradingTheme.secondaryAccent.withOpacity(0.5),
          title: Row(
            children: [
              Icon(
  ...
  Widget _buildDetailSection(
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Icon(icon, color: TradingTheme.secondaryAccent, size: 16),
            const SizedBox(width: 8),
            Text(
              title,
              style: const TextStyle(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(8),
            border:
                Border.all(color: TradingTheme.secondaryAccent.withOpacity(0.1)),
          ),
          child: Column(
            children: children,
          ),
