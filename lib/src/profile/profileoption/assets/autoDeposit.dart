...
class AutoDeposit1 extends StatefulWidget {
  const AutoDeposit1({Key? key}) : super(key: key);

  @override
  State<AutoDeposit1> createState() => _AutoDeposit1State();
}

class _AutoDeposit1State extends State<AutoDeposit1> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        //   indicatorColor: TradingTheme.secondaryAccent, // Binance yellow
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: TradingTheme.secondaryAccent.withOpacity(0.1), // Binance yellow with opacity
                                  borderRadius: BorderRadius.circular(4),
                                ),
                                child: Row(
                                  children: const [
                                    Icon(
                                      Icons.copy,
                                      color: TradingTheme.secondaryAccent, // Binance yellow
                                      size: 16,
                                    ),
                                    SizedBox(width: 4),
                                    Text(
