...
import 'package:rapidtradeai/src/profile/profileoption/assets/swap.dart';
...
class _AssetsState extends State<Assets> {
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            // Balance card
            Container(
              margin: EdgeInsets.all(kIsWeb ? 12 : 16), // Smaller margin for web to save space
              ...
              child: Padding(
                padding: EdgeInsets.all(kIsWeb ? 16 : 16), // Optimized padding for web to save space
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: kIsWeb ? 18 : 14, // Much bigger for web
                      ),
                    ),
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontSize: kIsWeb ? 32 : 24, // Much bigger for web
                          ),
                        ),
                        SizedBox(width: kIsWeb ? 6 : 4), // More spacing for web
                        Padding(
                          padding: EdgeInsets.only(bottom: kIsWeb ? 6 : 4), // More padding for web
                          child: Text(
                            "USD",
                            style: TextStyle(
                              color: Color(0xFF8A9CC0),
            ...
            // Action buttons
            Container(
              margin: EdgeInsets.symmetric(horizontal: kIsWeb ? 12 : 16), // Smaller margin for web
              child: Row(
            ...
            SizedBox(height: kIsWeb ? 8 : 16), // Smaller spacing for web to save space
  ...
  Widget _buildActionButton({
    ...
    // Theme colors
    const Color mediumBlue = Color(0xFF1A2235);
    const Color lightBlue = TradingTheme.secondaryAccent;

    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(8),
      child: Container(
        width: kIsWeb ? 100 : 90, // Slightly wider for web
        padding: EdgeInsets.symmetric(vertical: kIsWeb ? 8 : 12), // Smaller padding for web to save space
        decoration: BoxDecoration(
          color: mediumBlue,
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: TradingTheme.secondaryAccent.withOpacity(0.5),
            width: 1,
          ),
        ),
        child: Column(
          ...
          children: [
            Icon(
              icon,
              color: lightBlue,
              size: kIsWeb ? 20 : 24, // Smaller icon for web to save space
            ),
            SizedBox(height: kIsWeb ? 4 : 8), // Smaller spacing for web
            Text(
              label,
              style: TextStyle(
                color: Colors.white,
                fontSize: kIsWeb ? 14 : 12, // Bigger text for web readability
                fontWeight: FontWeight.w500,
              ),
            ),
          ],
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                Container(
                  width: kIsWeb ? 6 : 4, // Bigger indicator for web
                  height: kIsWeb ? 20 : 16, // Taller indicator for web
                  decoration: BoxDecoration(
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.bold,
                    fontSize: kIsWeb ? 20 : 16, // Much bigger for web
                  ),
                ),
              ],
            ),
                ...
                return InkWell(
                  ...
                  child: Container(
                    margin: EdgeInsets.symmetric(
                        horizontal: kIsWeb ? 24 : 16, vertical: kIsWeb ? 10 : 6), // Bigger margins for web
                    decoration: BoxDecoration(
                      color: mediumBlue,
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(
                    ...
                    child: Padding(
                      padding: EdgeInsets.all(kIsWeb ? 16 : 12), // Bigger padding for web
                      child: Row(
                        children: [
                          // Transaction icon
                          Container(
                            width: kIsWeb ? 48 : 40, // Bigger icon container for web
                            height: kIsWeb ? 48 : 40,
                            decoration: BoxDecoration(
                              color: darkBlue,
                            ...
                            child: Center(
                              child: Icon(
                                ...
                                size: kIsWeb ? 24 : 20, // Bigger icon for web
                              ),
                            ),
                          ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontSize: kIsWeb ? 16 : 12, // Much bigger for web
                                      ),
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                    ),
                                  ),
                                SizedBox(height: kIsWeb ? 6 : 4), // More spacing for web
                                Text(
                                  formattedDate,
                                  style: TextStyle(
                                    color: Color(0xFF8A9CC0),
