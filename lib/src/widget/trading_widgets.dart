...
class TradingStatsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedTradingCard(
      padding: EdgeInsets.all(kIsWeb ? 20 : 16), // Bigger padding for web
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              if (icon != null) ...[
                Icon(
                  icon,
                  color: TradingTheme.primaryAccent,
                  size: kIsWeb ? 24 : 18, // Bigger icon for web
                ),
              ...
              if (showTrend)
                Icon(
                  ...
                  size: kIsWeb ? 20 : 16, // Bigger trend icon for web
                ),
            ],
          ),
          ...
          Text(
            value,
            style: ResponsiveTradingTypography.priceText.copyWith( // Much bigger value text for web
